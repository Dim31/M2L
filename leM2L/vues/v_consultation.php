...
<th>Adresse mail</th><th>Cout hebergement</th>
...
foreach($bordereau as $lebordereau)
{
    ...
    echo "<tr><td>$adressemail</td><td>$date</td><td>$motif</td><td>$trajet</td><td>$km</td><td>$coutpeage</td><td>$coutrepas</td><td>$couthebergement</td></tr>";
?>
<br/><br/><br/>
<?php
